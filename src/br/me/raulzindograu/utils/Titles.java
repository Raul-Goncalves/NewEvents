package br.me.raulzindograu.utils;
    ...
    public void updateTimes(Player player) {
        if (Titles.packetTitle != null) {
            try {
                ...
                Method sendPacket = getMethod(connection.getClass(), "sendPacket");
                Object packet = Titles.packetTitle.getConstructor(new Class[]{Titles.packetActions, chatBaseComponent, Integer.TYPE, Integer.TYPE, Integer.TYPE}).newInstance(actions[2], null, Integer.valueOf(this.fadeInTime * (this.ticks ? 1 : 20)), Integer.valueOf(this.stayTime * (this.ticks ? 1 : 20)), Integer.valueOf(this.fadeOutTime * (this.ticks ? 1 : 20)));
    ...
    public void updateTitle(Player player) {
        if (Titles.packetTitle != null) {
            try {
                ...
                Object packet = Titles.packetTitle.getConstructor(new Class[]{Titles.packetActions, chatBaseComponent}).newInstance(actions[0], serialized);
                sendPacket.invoke(connection, packet);
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public void updateSubtitle(Player player) {
        if (Titles.packetTitle != null) {
            try {
                ...
                Object packet = Titles.packetTitle.getConstructor(new Class[]{Titles.packetActions, chatBaseComponent}).newInstance(actions[1], serialized);
                sendPacket.invoke(connection, packet);
            } catch (Exception e) {
                e.printStackTrace();
            }
